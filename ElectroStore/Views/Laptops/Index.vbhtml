...
<p>
    @Html.ActionLink("Create New Laptop (Make sure that you have created an electronic product first)", "Create")
</p>
<table class="table">
    <tr>
        <th>
    ...
    <td>
        @Html.DisplayFor(Function(modelItem) item.LaptopCPU.Brand)
    </td>
    <td>
        @Html.DisplayFor(Function(modelItem) item.LaptopGPU.Brand)
    </td>
    <td>
